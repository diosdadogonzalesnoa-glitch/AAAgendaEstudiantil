...
public class ApiAuthController {
    ...
    public ResponseEntity<?> register(@RequestBody Map<String, String> body) {
        ...
        if (email == null ||
    !(email.toLowerCase().endsWith("@utp.edu.pe")
      || email.toLowerCase().endsWith("@gmail.com"))) {

    return ResponseEntity.badRequest().body(
            Map.of("error", "El correo debe ser @utp.edu.pe o @gmail.com"));
}
    ...
    return ResponseEntity.badRequest().body(
            Map.of("error", "El correo de estudiante debe iniciar con U"));
}
    ...
    return ResponseEntity.badRequest().body(
            Map.of("error", "El correo de docente debe iniciar con C"));
}
